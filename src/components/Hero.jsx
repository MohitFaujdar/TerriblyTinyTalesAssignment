    ...
    <>
      ...
      <div className="max-w-4xl m-auto">
        ...
        <div className="mt-6 text-gray-700 px-6">
          ...
          <a
            href="https://github.com/MohitFaujdar"
        ...
        <div className="flex items-center space-x-4 mt-6 px-6">
          <div className="flex items-center space-x-2">
            <FaStar fill="teal" /> <span className="text-xs">120</span>
          </div>
          <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-2">
            <FaEye fill="gray" /> <span className="text-xs">10.03K</span>
          </div>
          <div className="flex items-center space-x-2">
            <FaHeart fill="red" /> <span className="text-xs">2.4K</span>
          </div>
        </div>
      </div>
    </>
